 ...
 *      This is the reference implementation from EIP-6492.
...
contract UniversalSigValidator {
    ...
    function isValidSig(
        ...
        if (
            ...
            if (_signer.code.length == 0) {
                ...
                require(success, "ERC6492: deployment failed");
                require(
                    _signer.code.length > 0,
                    "ERC6492: deployment did not deploy contract"
                );
            }
    ...
    /**
     * @notice View function version - reverts with result
     */
