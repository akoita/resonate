...
const CONTRACT_ENV_KEYS = [
    ...
    "NEXT_PUBLIC_BASE_SEPOLIA_SHOW_CAMPAIGN_ESCROW_ADDRESS",
] as const;
...
describe("getContractAddresses", () => {
    ...
    it("uses generic deployment env fallbacks for Base Sepolia", async () => {
        ...
        process.env.NEXT_PUBLIC_SHOW_CAMPAIGN_ESCROW_ADDRESS = "0x7777777777777777777777777777777777777777";
        ...
        expect(getAddresses(84532)).toEqual({
            ...
            showCampaignEscrow: "0x7777777777777777777777777777777777777777",
        });
    });
});
