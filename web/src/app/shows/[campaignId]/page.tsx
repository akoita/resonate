...
import { CampaignDetailHero } from "../../../components/shows/CampaignDetailHero";
...
import { CampaignMobilePledgeBar } from "../../../components/shows/CampaignMobilePledgeBar";
  ...
  return (
    <main className="shows-surface shows-page shows-page--wide">
      <div className="show-detail">
        ...
        <CampaignDetailHero campaign={campaign} tiers={tiers} />
        ...
        <div className="show-detail__body">
          ...
          <aside
            ...
            className="show-detail__pledge-rail"
            aria-label="Pledge terms and tiers"
          >
        ...
        <CampaignMobilePledgeBar campaign={campaign} />
      </div>
    </main>
  );
}
