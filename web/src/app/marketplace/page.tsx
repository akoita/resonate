                        ...
                        {filteredListings.map(listing => (
                            ...
                            >
                                ...
                                <div className="stem-card__artwork">
                                    <ListingArtwork
                                        src={resolveUrl(listing.stem?.artworkUrl) ?? (listing.stem?.releaseId ? getReleaseArtworkUrl(listing.stem.releaseId) : undefined)}
                                        alt={listing.stem?.title || "Stem"}
                                    />
