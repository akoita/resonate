...
function toFactRow(clean: EventsCleanRow): AnalyticsFactRow {
  return {
    ...
    dimensions: {
      ...
      actionKey: stringPayload(clean.payload, "actionKey"),
      actionStatus: stringPayload(clean.payload, "actionStatus"),
      actionKeys: arrayPayload(clean.payload, "actionKeys"),
      actionStatuses: arrayPayload(clean.payload, "actionStatuses"),
      ...
      startMs: numberPayload(clean.payload, "startMs"),
      endMs: numberPayload(clean.payload, "endMs"),
      segmentDurationMs: numberPayload(clean.payload, "segmentDurationMs"),
      target: stringPayload(clean.payload, "target"),
      configured: numberPayload(clean.payload, "configured"),
      remaining: numberPayload(clean.payload, "remaining"),
      ...
      listingId: stringPayload(clean.payload, "listingId"),
      stemId: stringPayload(clean.payload, "stemId"),
      lifecycleStatus: stringPayload(clean.payload, "lifecycleStatus"),
      relistableCount: numberPayload(clean.payload, "relistableCount"),
      expiredCount: numberPayload(clean.payload, "expiredCount"),
      expiringSoonCount: numberPayload(clean.payload, "expiringSoonCount"),
      activeCount: numberPayload(clean.payload, "activeCount"),
      totalListings: numberPayload(clean.payload, "totalListings"),
      ...
      campaignId: stringPayload(clean.payload, "campaignId"),
      campaignSlug: stringPayload(clean.payload, "campaignSlug"),
      campaignStatus: stringPayload(clean.payload, "campaignStatus"),
      city: stringPayload(clean.payload, "city"),
