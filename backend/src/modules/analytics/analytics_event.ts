...
export const ANALYTICS_EVENT_SCHEMA_EXAMPLES = [
  ...
  },
  {
    ...
    privacyTier: "pseudonymous",
    payloadFields: ["campaignId", "campaignSlug", "campaignStatus", "roomId", "roomType", "latestMessageId", "visibleUpdateCount"],
  },
  {
    ...
    producer: "community-service",
    privacyTier: "pseudonymous",
    payloadFields: ["cohortId", "cohortType", "reasonCode", "membershipStatus", "minimumSize", "visibleMemberCount"],
  },
  {
