...
const HIGH_VALUE_DOMAIN_EVENT_BRIDGES: readonly DomainBridgeConfig[] = [
  ...
  },
  {
    ...
    actorIdKeys: ["userId"],
    consentBasis: "artist_community_rooms:v1",
    payloadKeys: ["roomId", "roomType", "artistId"],
    sourceRefKeys: ["roomId", "roomType", "artistId"],
  },
  {
  ...
  },
  {
    ...
    actorIdKeys: ["userId"],
    consentBasis: "artist_community_rooms:v1",
    payloadKeys: ["roomId", "roomType", "artistId", "reason"],
    sourceRefKeys: ["roomId", "roomType", "artistId", "reason"],
  },
  {
    ...
    actorIdKeys: ["userId"],
    consentBasis: "artist_community_rooms:v1",
    payloadKeys: ["roomId", "messageId", "messageType"],
    sourceRefKeys: ["roomId", "messageId", "messageType"],
  },
  {
    ...
    actorIdKeys: ["userId"],
    consentBasis: "artist_community_rooms:v1",
    payloadKeys: ["roomId", "messageId", "reportId"],
    sourceRefKeys: ["roomId", "messageId", "reportId"],
  },
  {
    ...
    actorIdKeys: ["userId"],
    consentBasis: "artist_community_rooms:v1",
    payloadKeys: ["roomId", "messageId"],
    sourceRefKeys: ["roomId", "messageId"],
  },
  {
