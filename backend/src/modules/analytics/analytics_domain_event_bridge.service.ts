...
const HIGH_VALUE_DOMAIN_EVENT_BRIDGES: readonly DomainBridgeConfig[] = [
  ...
  },
  {
    ...
    payloadKeys: ["artistId", "benefitRuleId", "benefitType", "status"],
    sourceRefKeys: ["artistId", "benefitRuleId", "benefitType", "status"],
  },
  {
  ...
  },
  {
    ...
    subjectIdKeys: ["sourceId"],
    actorIdKeys: ["userId"],
    consentBasis: "community_badges_roles:v1",
    payloadKeys: ["badgeType", "sourceType", "sourceId", "campaignId", "artistId", "visibility"],
    sourceRefKeys: ["badgeType", "sourceType", "sourceId", "campaignId", "artistId"],
  },
  {
    eventName: "community.role_granted",
    producer: "community-service",
    subjectType: "community_role",
    subjectIdKeys: ["scopeId"],
    actorIdKeys: ["userId"],
    consentBasis: "community_badges_roles:v1",
    payloadKeys: ["roleType", "scopeType", "scopeId", "sourceType", "sourceId", "campaignId", "artistId", "visibility"],
    sourceRefKeys: ["roleType", "scopeType", "scopeId", "sourceType", "sourceId", "campaignId", "artistId"],
  },
  {
  ...
  },
  {
    ...
    payloadKeys: ["campaignId", "campaignSlug", "campaignStatus", "roomId", "roomType", "artistId", "city", "country"],
    sourceRefKeys: ["campaignId", "campaignSlug", "campaignStatus", "roomId", "roomType", "artistId", "city", "country"],
  },
  {
  ...
  },
  {
    ...
    sourceRefKeys: ["campaignId", "campaignSlug", "campaignStatus", "roomId", "roomType", "artistId", "latestMessageId", "city", "country"],
  },
  {
  ...
  },
  {
    ...
    payloadKeys: ["roomId", "messageId", "messageType", "campaignId", "campaignSlug", "campaignStatus", "city", "country"],
    sourceRefKeys: ["roomId", "messageId", "messageType", "campaignId", "campaignSlug", "campaignStatus", "city", "country"],
  },
  {
  ...
  },
  {
    ...
    payloadKeys: ["artistId", "publicLinkEnabled", "announcementMirrorEnabled", "roleSyncEnabled"],
    sourceRefKeys: ["artistId", "publicLinkEnabled", "announcementMirrorEnabled", "roleSyncEnabled"],
  },
  {
    ...
    actorIdKeys: ["actorId"],
    consentBasis: "artist_discord_bridge:v1",
    payloadKeys: ["artistId", "roomId", "messageId", "attemptId", "status"],
    sourceRefKeys: ["artistId", "roomId", "messageId", "attemptId", "status"],
  },
  {
    ...
    actorIdKeys: ["actorId"],
    consentBasis: "artist_discord_bridge:v1",
    payloadKeys: ["artistId", "mappingCount", "status", "reason"],
    sourceRefKeys: ["artistId", "mappingCount", "status", "reason"],
  },
  {
  ...
  },
  {
    ...
    subjectIdKeys: ["cohortId"],
    actorIdKeys: ["userId"],
    consentBasis: "community_cohort_matching:v1",
    payloadKeys: ["cohortId", "cohortType", "reasonCode", "membershipStatus", "minimumSize", "visibleMemberCount"],
    sourceRefKeys: ["cohortId", "cohortType", "reasonCode", "membershipStatus"],
  },
  {
  ...
  },
  {
    ...
    sourceRefKeys: ["creatorId", "sourceTrackId"],
  },
  {
