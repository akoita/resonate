...
export const SHOW_CAMPAIGN_FIXTURES: ShowCampaignFixture[] = [
  ...
  },
  {
    ...
    campaign: {
      ...
      heroAsset: "aya-nakamura-montreal-hero.webp",
      heroCredit: "Editorial press photo — Aya Nakamura at Vogue World: Paris, June 2024 (via RTL.fr); all rights reserved, demo use only",
    },
    gallery: [
      {
        key: "portrait",
        file: "aya-nakamura-portrait.webp",
        caption: "Aya Nakamura (2024).",
        credit: OFFICIAL_DEMO_CREDIT("Getty Images", "editorial photo, 2024"),
      },
      {
        key: "live",
        file: "aya-nakamura-live.webp",
      ...
      {
        key: "stage",
        file: "aya-nakamura-stage.webp",
        caption: "Aya Nakamura on stage (2023).",
        credit: OFFICIAL_DEMO_CREDIT("Getty Images", "editorial concert photo, 2023"),
      },
      {
        key: "city",
        file: "aya-nakamura-montreal-city.webp",
