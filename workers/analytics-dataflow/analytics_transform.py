                ...
                compact(
                    {
                        ...
                        "startMs": number_payload(payload, "startMs"),
                        "endMs": number_payload(payload, "endMs"),
                        "segmentDurationMs": number_payload(payload, "segmentDurationMs"),
                        "target": string_payload(payload, "target"),
                        "configured": number_payload(payload, "configured"),
                        "remaining": number_payload(payload, "remaining"),
