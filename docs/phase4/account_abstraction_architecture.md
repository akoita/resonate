...
> This research doc informed the decision to adopt **ZeroDev Kernel v3** for smart accounts with **passkey** authentication, **session keys** for agent delegation, and **ERC-6492** for counterfactual signature validation.

See [Account Abstraction Integration](../account-abstraction.md) for the implemented architecture and [ZeroDev Integration](../phase5/zerodev_integration.md) for the original design document.
