...
| -------- | --- | --- |
| **P0**   | Shows production go-live ([#1583](https://github.com/akoita/resonate/issues/1583), gated owner decision) + real campaign cohort | Line 1 live — first collected revenue |
