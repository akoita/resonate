...
| [2026-08-30](2026-08-30-vision-sprint-15-dependency-risk.md) | Vision Sprint 15 — triage and reduce dependency risk | ▶ Active — replace the initial alert snapshot with a reachability-aware baseline and remove safely remediable Critical/High paths |
