...
| [2026-08-28](2026-08-28-vision-sprint-14-retained-security-findings.md) | Vision Sprint 14 — close retained application security findings | ▶ Active — close the seven validated alerts retained from the initial CodeQL baseline |
