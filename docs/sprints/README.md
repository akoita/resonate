...
| [2026-08-30](2026-08-30-vision-sprint-17-platform-compatibility.md) | Vision Sprint 17 — platform compatibility and delivery confidence | ▶ Active — validate Glamsterdam repricing, Next.js 16.3, and the automatic merge queue |
| [2026-08-31](2026-08-31-vision-sprint-18-accessible-mobile-web.md) | Vision Sprint 18 — accessible, mobile-ready web experience | ▶ Active — #1440 started while Sprint 17's #1557 remains time-gated; mobile, accessibility, metadata, and User Guide completion |
