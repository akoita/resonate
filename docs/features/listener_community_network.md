...
artist/operator rule management. Listener-facing unlocked-benefit discovery is
still planned, and managed rule responses continue to hide raw proof details and
wallet addresses.
