...
| Campaign rooms | in-progress | Shows detail pages expose the first campaign supporter room slice: confirmed backers can unlock a private supporter room, artists/operators can post campaign updates, and compact campaign/community analytics are emitted. City demand groups, supporter badges/roles, and lifecycle reconciliation remain planned in [#1000](https://github.com/akoita/resonate/issues/1000) and the [Shows Campaign Rooms Plan](shows_campaign_rooms_plan.md). |
