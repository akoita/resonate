...
| Analytics event ledger | [Analytics Event Taxonomy v1](../architecture/analytics_event_taxonomy_v1.md), [Long-Term Analytics Event Ledger RFC](../rfc/analytics-event-ledger.md), [Analytics Consent And Retention Policy](analytics_consent_retention_policy.md) |
