...
- Browse UI (#1510): `web/src/app/drops/` and `web/src/components/drops/` —
  ...
  live in `web/src/styles/drops.css`; the filter deck reuses the Home v3 Tuner
  chip language (`.ng-filter-deck` in `web/src/styles/home-v3.css`).
