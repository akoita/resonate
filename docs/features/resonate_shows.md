...
attendance credentials should start as off-chain, opt-in, event-scoped badges
for post-show rewards or artist recognition, while city-scene membership and
private attendance history stay off-chain.
