...
- The deterministic selector now produces a bounded scored shortlist with explanation signals for taste match, expanded taste match, learned preference, active listings, text similarity, recent-track exclusion, optional sanitized warehouse taste explanations, joined-cohort context, and versioned metadata-derived audio feature vectors.
